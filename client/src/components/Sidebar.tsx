...
export function Sidebar() {
  ...
  const fraternityColors = {
    "Delta Tau Delta": "from-purple-600 to-amber-400", // DTD Purple & Gold
    "Sigma Chi": "from-blue-600 to-amber-400", // Sigma Chi Blue & Old Gold
    null: "from-primary to-primary/60" // Fallback
  };
